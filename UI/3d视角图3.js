...
function drawXYMap(canvas) {
  ...
  canvas.translate(
    mapCenX - player.x * mapScale,
    mapCenY - player.y * -mapScale,
  );
...
var isToDown = false;
ui.but_down.setOnTouchListener(
  new android.view.View.OnTouchListener({
    onTouch: function (view, event) {
      switch (event.getAction()) {
        case android.view.MotionEvent.ACTION_DOWN:
