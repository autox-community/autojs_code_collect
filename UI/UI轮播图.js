...
data = {
  ...
  data: [
    ...
    {
      onClick: "img_1",
      src: "http://m.360buyimg.com/mobilecms/s750x366_jfs/t1/67028/29/1545/96494/5cfe240cE56f068b4/6a4e92ba08ccbb9c.jpg!cr_1125x549_0_72!q70.jpg.dpg",
    },
    {
      onClick: "img_2",
      src: "http://m.360buyimg.com/mobilecms/s750x366_jfs/t1/75071/39/1612/313464/5cff0503E4572701b/b50443d23112a281.jpg!cr_1125x549_0_72!q70.jpg.dpg",
    },
    {
      onClick: "img_3",
      src: "http://m.360buyimg.com/mobilecms/s750x366_jfs/t1/46150/10/2005/121802/5cfe1d49E36aec0ae/affb9b6f9b54b42e.jpg!cr_1125x549_0_72!q70.jpg.dpg",
    },
  ],
};
...
var imgLayout = (function () {
  ...
  function imgLayout() {
    ...
    this.defineAttr("data", (view, attr, value, defineSetter) => {
      ...
      arr.title
        ? view._text.setText(arr.title)
        : view._text.attr("visibility", "gone");
...
var TabsLayout = (function () {
  ...
  function TabsLayout() {
    ...
    this.defineAttr("data", (view, attr, value, defineSetter) => {
      ...
      for (let i = 0; i < arr.length; i++) {
        tabs_view[tabs_view.length] = ui.inflate(
          <text text="●" marginLeft="5" />,
          view._tabs,
          true,
        );
      }
  ...
  TabsLayout.prototype.render = function () {
    return <horizontal id="_tabs" w="auto" h="auto" />;
  };
...
ui.open.click(() => {
  ...
  id = setInterval(function () {
    (time + 1) * 1000 >= data.time
      ? ((ui.viewpager_img.currentItem = ui.viewpager_img.currentItem + 1),
        (time = 0))
      : time++;
  }, 1000);
});
