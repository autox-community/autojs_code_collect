        ...
        <vertical id="applist">
          ...
          >
            <img
              w="28"
              h="28"
              src="@drawable/ic_add_circle_outline_black_48dp"
              tint="#FF03A9F5"
            />
          </card>
        </vertical>
...
ui.drawer.setDrawerListener(
  new DrawerLayout.DrawerListener({
    onDrawerSlide: function (drawerView, offset) {
      drawerView.scrollTo(
        ((offset - 1) * drawerView.getMeasuredWidth()) / 2,
        0,
      );
