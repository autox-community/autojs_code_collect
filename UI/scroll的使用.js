...
ui.layout(
  ...
  >
    <vertical>
      <horizontal>
        <button id="管家" textSize="16sp" margin="8" gravity="center">
          管家加人
        </button>
        <button id="白夫人" textSize="16sp" margin="8" gravity="center">
          白夫人减人
        </button>
        <button id="乔峰" textSize="16sp" margin="8" gravity="center">
          乔峰加布局
        </button>
      </horizontal>
      <horizontal>
        <button id="邓紫棋" textSize="16sp" margin="8" gravity="center">
          增加泡沫按钮
        </button>
        <button id="邓紫棋的泡沫" textSize="16sp" margin="8" gravity="center">
          遍历显示泡沫按钮
        </button>
      </horizontal>
    </vertical>
...
function 到底() {
  ...
  scrollView.scrollTo(
    0,
    ui.scrollVertical.getMeasuredHeight() - scrollView.getHeight(),
  );
}
function 到顶() {
  var scrollView = ui.scroll;
...
function getRndColor() {
  var a, r, g, b;
  (a = Math.floor(0)),
    (r = Math.floor(随机0_255())),
    (g = Math.floor(随机0_255())),
    (b = Math.floor(随机0_255()));
