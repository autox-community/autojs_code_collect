...
function 导入常用函数模块() {
  var url =
    "https://raw.githubusercontent.com/snailuncle/autojsDemo/master/autojsCommonFunctions.js";
  var r = http.get(url);
  ...
  <frame id="yidong1" margin="0" gravity="center" bg="#881e90ff">
    ...
    <vertical>
      ...
      <ScrollView id="As" h="*" bg="#882f4f4f">
        <text id="日志" textSize="8sp" textColor="#ff550000" margin="1">
          日志
        </text>
      </ScrollView>
    </vertical>
...
var 微信ua =
  "Mozilla/5.0 (Linux; Android 8.0.0; MI 6 Build/OPR1.170623.027; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/044432 Mobile Safari/537.36 MicroMesse你nger/6.6.1.1220(0x26060135) NetType/WIFI Language/zh_CN";
var 电脑ua =
...
ui.run(function () {
  //window.js.js日志('返回');
  w.a.evaluateJavascript(
    "console.log(11111);window.js.js日志('函数加载返回');",
    function (f) {
      toastLog("加载函数" + f);
    },
  );
