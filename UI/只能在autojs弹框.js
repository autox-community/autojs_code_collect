...
function getContext() {
  mThemeWrapper = new android.view.ContextThemeWrapper(
    runtime.uiHandler.getContext().getApplicationContext(),
    com.stardust.autojs.R.style.Theme_AppCompat_Light,
  );
  return mThemeWrapper;
}

var activity = getActivity();
var myView = ui.inflate(
  <LinearLayout
...
var progress_barId =
  com.stardust.autojs.core.ui.inflater.util.Ids.parse("progress_bar");
...
// ic_move_cursor.png
alert_img_id =
  com.stardust.autojs.core.ui.inflater.util.Ids.parse("ic_android_eat_js");
log("第一种获取id的办法,不能用");
log(alert_img_id);
...
// 设置旋转动画
var tranfrom = new android.view.animation.RotateAnimation(
  0,
  359,
  ...
  android.view.animation.Animation.RELATIVE_TO_SELF,
  0.5,
); //(359:旋转角度（可自调），若为360会有卡顿，正数为顺势针旋转，负数为逆时针)
