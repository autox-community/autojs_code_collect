...
window.ub.click(() => {
  alert(
    "需要存储权限，所以即使手机重启，计时器依旧继续运行，运行脚本就能看到计时数据，点击即使时间可以重置为00:00:00",
  );
});
window.ut.click(() => {
...
window.js0.click(() => {
  threads.start(function () {
    var ok = confirm("确定给0重新计时？");
    if (ok) {
      log("ok");
      txt1[0] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js1.click(() => {
  threads.start(function () {
    var ok = confirm("确定给1重新计时？");
    if (ok) {
      log("ok");
      txt1[1] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js2.click(() => {
  threads.start(function () {
    var ok = confirm("确定给2重新计时？");
    if (ok) {
      log("ok");
      txt1[2] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js3.click(() => {
  threads.start(function () {
    var ok = confirm("确定给3重新计时？");
    if (ok) {
      log("ok");
      txt1[3] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js4.click(() => {
  threads.start(function () {
    var ok = confirm("确定给4重新计时？");
    if (ok) {
      log("ok");
      txt1[4] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js5.click(() => {
  threads.start(function () {
    var ok = confirm("确定给5重新计时？");
    if (ok) {
      log("ok");
      txt1[5] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js6.click(() => {
  threads.start(function () {
    var ok = confirm("确定给6重新计时？");
    if (ok) {
      log("ok");
      txt1[6] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js7.click(() => {
  threads.start(function () {
    var ok = confirm("确定给7重新计时？");
    if (ok) {
      log("ok");
      txt1[7] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js8.click(() => {
  threads.start(function () {
    var ok = confirm("确定给8重新计时？");
    if (ok) {
      log("ok");
      txt1[8] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js9.click(() => {
  threads.start(function () {
    var ok = confirm("确定给9重新计时？");
    if (ok) {
      log("ok");
      txt1[9] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js10.click(() => {
  threads.start(function () {
    var ok = confirm("确定给10重新计时？");
    if (ok) {
      log("ok");
      txt1[10] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
...
window.js11.click(() => {
  threads.start(function () {
    var ok = confirm("确定给11重新计时？");
    if (ok) {
      log("ok");
      txt1[11] = new Date().getTime();
      var txt2 = txt1.join("\n");
      files.write(path, txt2);
    } else {
      log("no");
