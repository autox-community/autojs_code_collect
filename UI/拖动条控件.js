    ...
    view.btn_seekbar_bg_color.setOnTouchListener(function (_view, event) {
      switch (event.getAction()) {
        case event.ACTION_DOWN:
          ...
          animationScaleX = ObjectAnimator.ofFloat(
            view.btn_seekbar_bg_color,
            "scaleX",
            0.5,
            1,
          );
          animationScaleY = ObjectAnimator.ofFloat(
            view.btn_seekbar_bg_color,
            "scaleY",
            0.5,
            1,
      ...
      <frame w="*" margin="10 0">
        ...
        <frame marginTop="43">
          ...
          <frame id="scale_left" w="32" h="32" marginTop="6">
            <img
              id="scale_left_src"
              src="@drawable/ic_label_black_48dp"
              rotation="-90"
            />
            <text
              id="scale_left_text"
...
ui.layout(
  <vertical>
    ...
    <seekbar-layout
      ...
      title="G通道"
      subTitle="G"
      onClick="colorPreview('G',index)"
      scaleIconVisibility="false"
    />
    <seekbar-layout
      color="#2962ff"
      max="255"
