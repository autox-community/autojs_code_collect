...
function 获取图片验证码() {
  ui.run(function () {
    var webScript = {};
    webScript.getVerificationCodePicture =
      function getVerificationCodePicture() {
    ...
    var webViewScriptContent = packedAsWebScript(
      webScript.getVerificationCodePicture,
    );
    ...
    webView.evaluateJavascript(";" + webViewScriptContent + ";", function (s) {
      ...
      var bitmapTem = Bitmap.createBitmap(
        width,
        height,
      ...
      var verificationCodePath =
        files.getSdcardPath() + "/pictureVerificationCode.png";
