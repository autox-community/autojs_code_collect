...
//为页面设置渐变色背景
ui.firstpage.backgroundDrawable = GradientDrawable("TL_BR", [
  "#81C784",
  "#2E7D32",
  "#2E7D32",
]);
ui.page1.backgroundDrawable = GradientDrawable("TL_BR", [
  "#4FC3F7",
  "#0277BD",
  "#0277BD",
]);
ui.page2.backgroundDrawable = GradientDrawable("TL_BR", [
  "#FFF176",
  "#F9A825",
  "#F9A825",
]);
ui.permissionpage.backgroundDrawable = GradientDrawable("TL_BR", [
  "#80DEEA",
  "#0097A7",
  "#0097A7",
]);
ui.startpage.backgroundDrawable = GradientDrawable("TL_BR", [
  "#CFD8DC",
  "#78909C",
  "#78909C",
]);
...
ui.viewpager.setOnPageChangeListener({
  onPageSelected: function (index) {
    if (index == ui.viewpager.childCount - 1 && getMissingPermission()) {
      ...
      //打开授权页时自动检查授权以更正提示内容
      if (!getMissingPermission()) ui.permission.setText("已获得授权");
      else ui.permission.setText("单击此处进行授权");
    }
