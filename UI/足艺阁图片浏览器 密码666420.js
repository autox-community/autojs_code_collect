    ...
    var i = {},
      ...
      n = (m.Latin1 = {
        stringify: function (a) {
          for (var e = a.words, a = a.sigBytes, c = [], b = 0; b < a; b++)
            c.push(
              String.fromCharCode((e[b >>> 2] >>> (24 - 8 * (b % 4))) & 255),
            );
          return c.join("");
        },
        parse: function (a) {
  ...
  p.enc.Base64 = {
    stringify: function (i) {
      ...
      for (var i = [], m = 0; m < h; m += 3)
        for (
          var s =
              (((l[m >>> 2] >>> (24 - 8 * (m % 4))) & 255) << 16) |
              (((l[(m + 1) >>> 2] >>> (24 - 8 * ((m + 1) % 4))) & 255) << 8) |
              ((l[(m + 2) >>> 2] >>> (24 - 8 * ((m + 2) % 4))) & 255),
            n = 0;
          4 > n && m + 0.75 * n < h;
          n++
        )
...
(function (p) {
  ...
  n = n.MD5 = m.extend({
    ...
    _doProcessBlock: function (f, g) {
      ...
      for (
        var e = this._hash.words, c = e[0], b = e[1], d = e[2], q = e[3], a = 0;
        64 > a;
        a += 4
      )
        16 > a
          ? ((c = h(c, b, d, q, f[g + a], 7, k[a])),
            (q = h(q, c, b, d, f[g + a + 1], 12, k[a + 1])),
            (d = h(d, q, c, b, f[g + a + 2], 17, k[a + 2])),
            (b = h(b, d, q, c, f[g + a + 3], 22, k[a + 3])))
          : 32 > a
            ? ((c = i(c, b, d, q, f[g + ((a + 1) % 16)], 5, k[a])),
              (q = i(q, c, b, d, f[g + ((a + 6) % 16)], 9, k[a + 1])),
              (d = i(d, q, c, b, f[g + ((a + 11) % 16)], 14, k[a + 2])),
              (b = i(b, d, q, c, f[g + (a % 16)], 20, k[a + 3])))
            : 48 > a
              ? ((c = l(c, b, d, q, f[g + ((3 * a + 5) % 16)], 4, k[a])),
                (q = l(q, c, b, d, f[g + ((3 * a + 8) % 16)], 11, k[a + 1])),
                (d = l(d, q, c, b, f[g + ((3 * a + 11) % 16)], 16, k[a + 2])),
                (b = l(b, d, q, c, f[g + ((3 * a + 14) % 16)], 23, k[a + 3])))
              : ((c = r(c, b, d, q, f[g + ((3 * a) % 16)], 6, k[a])),
      ...
      k = ((h.format = {}).OpenSSL = {
        stringify: function (a) {
          var d = a.ciphertext,
            a = a.salt,
            d = (
              a ? r.create([1398893684, 1701076831]).concat(a).concat(d) : d
            ).toString(m);
...
ꕣ =
  "";
try {
  ꕤ = CryptoJS.AES.decrypt(ꕣ, prompt("输入密码才能继续")).toString(
    CryptoJS.enc.Utf8,
  );
} catch (e) {
  alert("密码错误");
