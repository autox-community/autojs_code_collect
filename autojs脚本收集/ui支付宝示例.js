...
//IMG图片数据
img_zfb =
  "http://gdown.baidu.com/img/0/512_512/4bfcfd18afa6dc68ef84b00302344dbd.png";
img_wx =
  "https://16570095.s21i.faiusr.com/4/ABUIABAEGAAgh9i35gUogKLn1wUwgAQ4gAQ.png";
img_user =
  "https://16570095.s21i.faiusr.com/2/ABUIABACGAAgu9y35gUo0Mbk_AUw9AM49AM.jpg";
  ...
  setMealLayout.prototype.onViewCreated = function (view) {
    view.on("click", () => {
      if (this._onClick) {
        ...
        ui.money_s.setText(
          "你已选择" + ui.money_name.text() + view._month.text() + "套餐",
        );
    ...
    return (
      <horizontal h="*" w="*" bg="{{MyColor}}" gravity="center_vertical">
        ...
        <vertical w="*" h="44" marginLeft="10">
          ...
          <text
            text="{{user.time_off}}到期，购买后有效期将延顺"
            h="*"
            gravity="center_vertical"
            textColor="#80ffffff"
          />
          ...
          <frame>
            <frame alpha="0.6">
              <img
                ...
                w="70"
                h="70"
                src="@drawable/ic_sentiment_dissatisfied_black_48dp"
                layout_gravity="center"
                marginBottom="10"
                tint="#ffffff"
                alpha="0"
...
ui.pay_bnt_bg.on("click", () => {
  ...
  if (!pay_money) {
    dialogs.alert("请选择续费套餐");
    return;
  }
  if (!pay) {
    dialogs.alert("请选择支付方式");
    return;
  }
  ui.run(function () {
...
function pay_loading() {
  ...
  ui.run(function () {
    ...
    set = new AnimatorSet();
    set.playTogether(slX, slY, animator, animator1);
