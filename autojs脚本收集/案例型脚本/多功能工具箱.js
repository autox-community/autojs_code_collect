...
const Spiccode = "v0.0.15";
const curFileName = "不知道叫什么好";
var bgcolor = "#ffffff";
var color = "#000000";
var color = "#009688";
var array = [];
...
ui.layout(
  <drawer id="drawer">
    <vertical h="*" w="*">
      <appbar>
        <toolbar id="toolbar" textSize="16sp" title="{{Spiccode}}" />
      </appbar>
...
var slowAES = {
  aes: {
    ...
    encrypt: function (input, key, size) {
      ...
      for (var k = 0; k < 4; k++)
        for (var l = 0; l < 4; l++) output[k * 4 + l] = block[k + l * 4];
      return output;
    },
...
var 调色板 = {
  ...
  initList: function () {
    ...
    var thread = threads.start(function () {
      setInterval(() => {
        (a = Math.floor(ui.proA.getProgress())),
          (r = Math.floor(ui.proR.getProgress())),
          (g = Math.floor(ui.proG.getProgress())),
          (b = Math.floor(ui.proB.getProgress()));
        ui.run(() => {
