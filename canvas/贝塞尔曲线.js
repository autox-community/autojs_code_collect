...
//android.graphics
var rainbowColor = [
  -65536, -23296, -256, -16711936, -16744449, -16776961, -7667457,
];

var storage = storages.create("曲线");
var pointsAry = [
  533.0925903320312, 1274.8876953125, 10.490286827087402, 906.9931640625,
  919.14892578125, 774.5621948242188, 291.7298889160156, 1186.8128662109375,
  771.2858276367188, 1183.8489990234375, 156.355224609375, 782.0582275390625,
  1055.023193359375, 901.0370483398438, 539.50048828125, 1276.30078125,
];
...
ui.canvas.on("draw", function (canvas) {
  ...
  try {
    ...
    Curve(
      canvas,
      pointsAry,
      Math.floor(T) % 2 ? 1 - (T - Math.floor(T)) : T - Math.floor(T),
      paint,
      path,
    );
    //递归绘制
