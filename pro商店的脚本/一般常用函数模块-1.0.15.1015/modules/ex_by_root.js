    ...
    switch (type) {
      case 1: {
        app.startActivity({
          ...
          extras: {
            extra_data:
              '{"recv_type":1,"recv_uin":' +
              friendsaccount +
              ',"channel":1,"bus_type":"1"}',
        ...
        app.startActivity({
          ...
          extras: {
            extra_data:
              '{"recv_type":1,"recv_uin":' +
              friendsaccount +
              ',"channel":32,"bus_type":"2","extra_info":{"redgift_type":"3","redgift_subtype":"1"}}',
            app_info: "appid#1344242394|bargainor_id#1000030201|channel#aio",
          },
          root: true,
        });
    ...
    switch (type) {
      case 1: {
        app.startActivity({
          ...
          extras: {
            extra_data:
              '{"recv_type":3,"recv_uin":' +
              QGroup +
              ',"channel":1,"bus_type":"1","people_num":1000}',
            app_info: "appid#1344242394|bargainor_id#1000030201|channel#aio",
          },
          root: true,
        });
        ...
        app.startActivity({
          ...
          extras: {
            extra_data:
              '{"recv_type":3,"recv_uin":' +
              QGroup +
              ',"channel":1,"bus_type":"2","people_num":1000}',
            app_info: "appid#1344242394|bargainor_id#1000030201|channel#aio",
          },
          root: true,
        });
        ...
        app.startActivity({
          ...
          extras: {
            extra_data:
              '{"recv_type":3,"recv_uin":"' +
              groupNumber +
              '","channel":32,"bus_type":"2","people_num":14,"extra_info":{"redgift_type":"3","redgift_subtype":"0"}}',
            app_info: "appid#1344242394|bargainor_id#1000030201|channel#aio",
          },
          root: true,
        });
