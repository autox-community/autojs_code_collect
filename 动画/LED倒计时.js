    ...
    <frame id="bg" w="400" h="400" layout_gravity="center">
      ...
      <frame id="jd" w="400" h="400" rotation="175.00">
        <img
          ...
          src="http://www.dyhywz.com/jdt.png"
        />
...
function 倒计时() {
  ...
  for (let E = 5; E > -1; E--) {
    ...
    ui.run(function () {
      animator1 = ObjectAnimator.ofFloat(
        num[E][0][0],
        "alpha",
        parseInt(num[E][0][0].getAlpha()),
        num[E][0][1],
      );
      animator2 = ObjectAnimator.ofFloat(
        num[E][1][0],
        "alpha",
        parseInt(num[E][1][0].getAlpha()),
        num[E][1][1],
      );
      animator3 = ObjectAnimator.ofFloat(
        num[E][2][0],
        "alpha",
        parseInt(num[E][2][0].getAlpha()),
        num[E][2][1],
      );
      animator4 = ObjectAnimator.ofFloat(
        num[E][3][0],
        "alpha",
        parseInt(num[E][3][0].getAlpha()),
        num[E][3][1],
      );
      animator5 = ObjectAnimator.ofFloat(
        num[E][4][0],
        "alpha",
        parseInt(num[E][4][0].getAlpha()),
        num[E][4][1],
      );
      animator6 = ObjectAnimator.ofFloat(
        num[E][5][0],
        "alpha",
        parseInt(num[E][5][0].getAlpha()),
        num[E][5][1],
      );
      animator7 = ObjectAnimator.ofFloat(
        num[E][6][0],
        "alpha",
        parseInt(num[E][6][0].getAlpha()),
        num[E][6][1],
      );
      set = new AnimatorSet();
      set.playTogether(
  ...
  ui.run(function () {
    ...
    animator1 = ObjectAnimator.ofFloat(
      num[num_n][0][0],
      "alpha",
      parseInt(num[num_n][0][0].getAlpha()),
      0,
    );
    animator2 = ObjectAnimator.ofFloat(
      num[num_n][1][0],
      "alpha",
      parseInt(num[num_n][1][0].getAlpha()),
      0,
    );
    animator3 = ObjectAnimator.ofFloat(
      num[num_n][2][0],
      "alpha",
      parseInt(num[num_n][2][0].getAlpha()),
      0,
    );
    animator4 = ObjectAnimator.ofFloat(
      num[num_n][3][0],
      "alpha",
      parseInt(num[num_n][3][0].getAlpha()),
      0,
    );
    animator5 = ObjectAnimator.ofFloat(
      num[num_n][4][0],
      "alpha",
      parseInt(num[num_n][4][0].getAlpha()),
      0,
    );
    animator6 = ObjectAnimator.ofFloat(
      num[num_n][5][0],
      "alpha",
      parseInt(num[num_n][5][0].getAlpha()),
      0,
    );
    animator7 = ObjectAnimator.ofFloat(
      num[num_n][6][0],
      "alpha",
      parseInt(num[num_n][6][0].getAlpha()),
      0,
    );
    set = new AnimatorSet();
    set.playTogether(
