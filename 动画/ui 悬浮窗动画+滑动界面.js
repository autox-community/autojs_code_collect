...
win = floaty.rawWindow(
  <frame w="{{w}}px" h="{{h}}px">
    <frame
      ...
      w="{{40*v_win}}px"
      h="{{40*v_win}}px"
      marginTop="{{(h-(h_win*v_win))/2}}px"
      marginRight="{{(w-(w_win*v_win))/2}}px"
    ...
    <frame>
      <card
        ...
        w="{{w_win*v_win}}px"
        h="{{h_win*v_win}}px"
        cardCornerRadius="{{(20*v_win)}}px"
        cardBackgroundColor="{{界面信息[当前界面][1]}}"
      ...
      >
        <frame h="*">
          <card
            w="{{100*v_win}}px"
            h="{{30*v_win}}px"
            cardCornerRadius="{{16*v_win}}px"
            marginTop="-{{15*v_win}}px"
          ...
          >
            <frame
              ...
              marginBottom="{{1*v_win}}px"
              w="auto"
              h="{{14*v_win}}px"
            >
              <text
                text="{{落款}}"
                textSize="{{10*v_win}}px"
                textColor="#ffffff"
            ...
            >
              ...
              <text
                ...
                text="你好,大柒!
                        ...
                        点击下方导航
                        切换界面"
                marginTop="{{40*v_win}}px"
                textSize="{{24*v_win}}px"
                textColor="{{白}}"
                gravity="center_horizontal"
                layout_gravity="center_horizontal"
                textStyle="bold"
  ...
  switch (event.getAction()) {
    ...
    case event.ACTION_MOVE:
      if (!yd) {
        ...
        if (
          Math.abs(event.getRawY() - y) < 300 &&
          Math.abs(event.getRawX() - x) > 300
        ) {
          yd = true;
        }
      }
...
function 动画(A) {
  ...
  Animator0 = ObjectAnimator.ofFloat(
    //小白球移动动画
    win.导航,
    "translationX",
    当前界面 * 导航X差值,
