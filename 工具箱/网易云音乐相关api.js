...
NeteaseCloudMusic = {
  //给Cookie用的
  MUSUC_U:
    "1a4372514fdafca040210ec0652560d35157299fb65cde76f2d3fd620bb608a15ae0d78b925f50ab1ca91cba586f29c731b299d667364ed3",
  ...
  getHeader: function () {
    return [
      ...
      [
        "Cookie",
        "__remember_me=true; MUSIC_U=" +
          this.MUSIC_U +
          "; __csrf=" +
          this.__csrf +
          "; os=android; osver=7.1.2; appver=5.4.1; deviceId=" +
          this.devideId +
          ";",
      ],
    ];
  ...
  API: {
    search: function (key, size, page, type) {
      ...
      return NeteaseCloudMusic.Operator.post(
        url,
        encrypted,
        NeteaseCloudMusic.getHeader(),
      );
    },
  ...
  EncryptUtils: {
    aesEncrypt: function (text, key) {
      var ivParameterSpec = new javax.crypto.spec.IvParameterSpec(
        java.lang.String("0102030405060708").getBytes("UTF-8"),
      );
    ...
    rsaEncrypt: function (text, pubKey, modulus) {
      ...
      var biginteger = new java.math.BigInteger(
        java.lang.String.format(
          "%x",
          new java.math.BigInteger(1, text.getBytes()),
        ),
        16,
      ).modPow(
        new java.math.BigInteger(pubKey, 16),
        new java.math.BigInteger(modulus, 16),
      );
      var hexString = java.lang.String(biginteger.toString(16));
      if (java.lang.String(hexString).length() >= 256) {
        return hexString.substring(
          hexString.length() - 256,
          hexString.length(),
        );
      } else {
    ...
    getRandomString: function (length) {
      ...
      for (var i = 0; i < length; i++) {
        stringBuffer.append(
          string.charAt(Math.round(Math.random() * (string.length - 1))),
        );
      }
    ...
    encryptParam: function (text) {
      ...
      try {
        return (
          "params=" +
          java.net.URLEncoder.encode(encText, "UTF-8") +
          "&encSecKey=" +
          java.net.URLEncoder.encode(encSecKey, "UTF-8")
        );
      } catch (error) {
    ...
    md5Encrypt: function (string) {
      ...
      var byteArr = new java.lang.reflect.Array.newInstance(
        java.lang.Byte.TYPE,
        charArr.length,
      );
