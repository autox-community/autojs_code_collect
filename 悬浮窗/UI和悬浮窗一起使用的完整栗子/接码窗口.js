  ...
  <vertical bg="#FFB6C1">
    ...
    <TableLayout>
      <TableRow>
        ...
        />
        <button id="copyPhone" layout_weight="1">
          复制号码
        </button>
      </TableRow>
      <TableRow>
        ...
        <button id="copySms" layout_weight="1">
          复制短信
        </button>
      </TableRow>
    </TableLayout>
    <horizontal weightSum="10" bg="#888888">
      <button id="随机号码" layout_width="0dp" layout_weight="3">
        随机号码
      </button>
      <button id="移动" layout_width="0dp" layout_weight="2">
        移动
      </button>
      <button id="隐藏" layout_width="0dp" layout_weight="2">
        隐藏
      </button>
      <button id="指定号码" layout_width="0dp" layout_weight="3">
        指定号码
      </button>
    </horizontal>
  </vertical>,
...
接码窗口.随机号码.click(function () {
  threads.start(function () {
    toastLog("这里写接码平台接码函数,并把收到的手机号码显示到手机号码输入框");
  });
});
接码窗口.指定号码.click(function () {
  threads.start(function () {
    toastLog(
      "这里写接码平台获取指定号码的函数,并把收到的手机号码显示到手机号码输入框",
    );
  });
});
