...
var 小白点悬浮球的小白点点击事件 = new View点击事件(
  小白点悬浮球,
  "小白点",
  小白点悬浮球.小白点,
);
...
var 信息显示的信息显示点击事件 = new View点击事件(
  信息显示,
  "信息显示",
  信息显示.信息显示,
);
...
function 滑动效果(window, endXY, spendTime) {
  var startXY = [window.getX(), window.getY()];
