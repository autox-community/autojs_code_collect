...
function 控制台() {
      ...
      <vertical gravity="right">
        ...
        <linear gravity="center">
          <vertical margin="3" bg="#77ffffff" gravity="top">
            ...
            <text id="上坐标" textColor="red" textSize="10sp">
              上坐标
            </text>
          </vertical>
          <vertical margin="3" bg="#77ffffff" gravity="top">
            ...
            <text id="下坐标" textColor="red" textSize="10sp">
              下坐标
            </text>
          </vertical>
        </linear>
        <text id="截图大小" textColor="red" textSize="10sp">
          图片大小:000X000
        </text>
        <scroll gravity="left" h="40" ellipsize="marquee">
          <text id="timu" textColor="red" textSize="10sp">
            题目：攀登、白酒煮饭、专业滥竽充数
          </text>
        </scroll>
  ...
  w.下0.click(() => {
    if (
      上部坐标[1] < 1920 - 99 + ztl - 1 &&
      上部坐标[1] + 99 + ztl < 下部坐标[1] + 545 + ztl - 1
    )
      上部坐标[1]++;
    窗口移动(0, 上部坐标[0], 上部坐标[1]);
  });
  ...
  w.右0.click(() => {
    if (上部坐标[0] < 1080 - 39 - 1 && 上部坐标[0] + 39 < 下部坐标[0] + 482 - 1)
      上部坐标[0]++;
    窗口移动(0, 上部坐标[0], 上部坐标[1]);
  });
  w.移动0.setOnTouchListener(function (view, event) {
    switch (event.getAction()) {
      ...
      case event.ACTION_MOVE:
        ...
        if (上部坐标[1] > 1920 - 99 + ztl - 1)
          上部坐标[1] = 1920 - 99 + ztl - 1;
        if (上部坐标[0] + 39 > 下部坐标[0] + 482 - 1)
          上部坐标[0] = 下部坐标[0] + 482 - 1 - 39;
        if (上部坐标[1] + 99 > 下部坐标[1] + 545 - 1)
          上部坐标[1] = 下部坐标[1] + 545 - 1 - 99;
        窗口移动(0, 上部坐标[0], 上部坐标[1]);
      case event.ACTION_UP:
    }
    return true;
  ...
  w.上1.click(() => {
    if (
      下部坐标[1] > -545 + ztl + 1 &&
      下部坐标[1] + 545 + ztl > 上部坐标[1] + 99 + ztl + 1
    )
      下部坐标[1]--;
  ...
  w.左1.click(() => {
    if (下部坐标[0] > -482 + 1 && 下部坐标[0] + 482 > 上部坐标[0] + 39 + 1)
      下部坐标[0]--;
    窗口移动(1, 下部坐标[0], 下部坐标[1]);
  });
  w.右1.click(() => {
  ...
  w.移动1.setOnTouchListener(function (view, event) {
    switch (event.getAction()) {
      ...
      case event.ACTION_MOVE:
        ...
        if (下部坐标[0] + 482 < 上部坐标[0] + 39 + 1)
          下部坐标[0] = 上部坐标[0] + 39 + 1 - 482;
        if (下部坐标[1] + 545 < 上部坐标[1] + 99 + 1)
          下部坐标[1] = 上部坐标[1] + 99 + 1 - 545;
        窗口移动(1, 下部坐标[0], 下部坐标[1]);
      case event.ACTION_UP:
    }
    return true;
