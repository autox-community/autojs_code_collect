...
ui.layout(
  <vertical background="http://1.119.192.186:8088/img/bg1.jpg">
    ...
    <vertical marginTop="13">
      ...
      <linear>
        <input
          ...
          w="154"
          hint="长度[6-32位]"
          bg="http://1.119.192.186:8088/img/a6.png"
        />
        <input
          id="passnum"
          paddingLeft="5"
    ...
    <input
      ...
      paddingLeft="5"
      gravity="top"
      bg="http://1.119.192.186:8088/img/TextBg1.png"
      color="#000000"
      size="15"
      margin="15 16 0 16"
      w="*"
    ...
    <linear gravity="center">
      <button
        id="make"
        h="35"
        bg="http://1.119.192.186:8088/img/produce.jpg"
        margin="16"
      ></button>
      <button
        id="copy"
        h="35"
        bg="http://1.119.192.186:8088/img/copy.jpg"
        margin="16"
      ></button>
    </linear>
  </vertical>,
