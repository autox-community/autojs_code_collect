...
var getPropListHtml = http.post(
  "http://newpai.xiaoxi6.com/lianpai/navigation/getproplist.html",
  {
    user_id: userId,
  },
  getHeaders(),
...
if (info) {
  ...
  for (let i = 0; i < propListArry.length; i++) {
    ...
    var getPropHtml = http.post(
      "http://newpai.xiaoxi6.com/lianpai/navigation/get_prop.html",
      {
        user_id: userId,
        prop_id: propId,
      },
