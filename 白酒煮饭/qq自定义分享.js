      ...
      <vertical align="top" margin="0">
        ...
        <linear>
          ...
          <input
            id="anr"
            w="*"
            text="南城在校大学生张某某贩卖autojs脚本被刑拘，南城警方正在调查中....."
            bg="#ffffff"
            h="45"
            hint="输入内容。"
          ></input>
        ...
        <linear>
          ...
          <input
            id="atp"
            w="*"
            text="http://img04.sogoucdn.com/app/a/100520146/d5f7cece76bfbf65c42ebe18b7fda989"
            bg="#ffffff"
            h="45"
            hint="输入网址。"
          ></input>
...
function si() {
  t =
    "mqqapi://share/to_fri?file_type=news&src_type=web&version=1&share_id=" +
    ui.aid.text() +
    "&url=" +
    jm(ui.alj.text()) +
    ...
    "&description=" +
    jm(ui.anr.text()) +
    "&callback_type=scheme&thirdAppDsplayName=ufcujgcuggiccikc&app_name=UVE&cflag=0&shareType=0";
  log(t);
