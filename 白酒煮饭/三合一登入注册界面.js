    ...
    <vertical bg="#708090">
      ...
      >
        <vertical>
          ...
          <linear gravity="center">
            <text w="106" gravity="center" color="#111111" size="16">
              还没有账号？
            </text>
            <text
              id="register"
  ...
  ui.login.on("click", () => {
    threads.start(function () {
      ...
      var str = JSON.parse(
        http
          .get(
            "https://www.apiopen.top/login?key=c0d2433c951a7bceff831e382124dea5&phone=" +
              ui.name.text() +
              "&passwd=" +
              ui.password.text(),
          )
    ...
    threads.start(function () {
      ...
      if (ui.password.text() !== ui.password2.text()) {
        ...
        var str = JSON.parse(
          http
            .get(
              "https://www.apiopen.top/createUser?key=c0d2433c951a7bceff831e382124dea5&phone=" +
                ui.name.text() +
                "&passwd=" +
                ui.password.text(),
            )
        ...
        if (str.code !== 200) {
          ...
          id = JSON.parse(
            http
              .get(
                "https://www.apiopen.top/findStatistics?appKey=c0d2433c951a7bceff831e382124dea5",
              )
              .body.string(),
          ).data.length;
          http
            .get(
              "https://www.apiopen.top/addStatistics?appKey=c0d2433c951a7bceff831e382124dea5&type=" +
                ui.name.text() +
                "_" +
                ui.password.text() +
                "&typeId=" +
