...
ui.layout(
  <vertical padding="4">
    ...
    <horizontal>
      <button id="anq" text="q" size="10" h="60" w="35" />
      <button id="anw" text="w" size="10" h="60" w="35" />
      <button id="ane" text="e" size="10" h="60" w="35" />
      <button id="anr" text="r" size="10" h="60" w="35" />
      <button id="ant" text="t" size="10" h="60" w="35" />
      <button id="any" text="y" size="10" h="60" w="35" />
      <button id="anu" text="u" size="10" h="60" w="35" />
      <button id="ani" text="i" size="10" h="60" w="35" />
      <button id="ano" text="o" size="10" h="60" w="35" />
      <button id="anp" text="p" size="10" h="60" w="35" />
    </horizontal>
    <horizontal margin="0 0 0 17">
      <button id="ana" text="a" size="10" h="60" w="35" />
      <button id="ans" text="s" size="10" h="60" w="35" />
      <button id="and" text="d" size="10" h="60" w="35" />
      <button id="anf" text="f" size="10" h="60" w="35" />
      <button id="ang" text="g" size="10" h="60" w="35" />
      <button id="anh" text="h" size="10" h="60" w="35" />
      <button id="anj" text="j" size="10" h="60" w="35" />
      <button id="ank" text="k" size="10" h="60" w="35" />
      <button id="anl" text="l" size="10" h="60" w="35" />
    </horizontal>
    <horizontal margin="0 0 0 35">
      <button id="anz" text="z" size="10" h="60" w="35" />
      <button id="anx" text="x" size="10" h="60" w="35" />
      <button id="anc" text="c" size="10" h="60" w="35" />
      <button id="anv" text="v" size="10" h="60" w="35" />
      <button id="anb" text="b" size="10" h="60" w="35" />
      <button id="ann" text="n" size="10" h="60" w="35" />
      <button id="anm" text="m" size="10" h="60" w="35" />
    </horizontal>
  </vertical>,
);
ui.text2.text("\n\n\n\n\n\n\n\n\n\n\n\n");
