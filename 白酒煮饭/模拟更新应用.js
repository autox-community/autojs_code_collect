...
function m() {
  ...
  if (s != undefined) {
      ...
      threads.start(function () {
        ...
        var data = http
          .get(url, {
            headers: {
              "User-Agent":
                "Mozilla/5.0 (Linux; U; Android 5.1.1; zh-cn; NX529J Build/LMY47V) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Mobile Safari/533.1/kdxj/1.1.3",
            },
          })
          .body.bytes();
    ...
    threads.start(function () {
      //发送post获取是否有更新文件
      var d = http
        .post("http://www.time.ac.cn/timeflash.asp?user=flash", {
          headers: {
            "User-Agent":
              "Mozilla/5.0 (Linux; U; Android 5.1.1; zh-cn; NX529J Build/LMY47V) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Mobile Safari/533.1/kdxj/1.1.3",
          },
