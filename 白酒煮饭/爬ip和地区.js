let html = http
  .get("http://www.xicidaili.com/nn/1", {
    headers: {
      Host: "www.xicidaili.com",
      Connection: "keep-alive",
      "Upgrade-Insecure-Requests": "1",
      "User-Agent":
        "Mozilla/5.0 (Linux; Android 9; MI 8 UD Build/PKQ1.180729.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.91 Mobile Safari/537.36",
      Accept:
...
while (i < Pg) {
  let html = http
    .get("http://www.xicidaili.com/nn/" + i, {
      headers: {
        Host: "www.xicidaili.com",
        Connection: "keep-alive",
        "Upgrade-Insecure-Requests": "1",
