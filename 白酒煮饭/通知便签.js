...
function showNotification(id, text) {
  ...
  nof.setLargeIcon(
    android.graphics.BitmapFactory.decodeResource(
      ...
      com.stardust.scriptdroid.R.drawable.autojs_material,
    ),
  );
  var intent = new android.content.Intent(
    android.content.Intent.ACTION_VIEW,
    android.net.Uri.fromFile(engines.myEngine().getSource().getFile()),
  );
  intent.setClassName(
    "com.stardust.scriptdroid",
    "com.stardust.scriptdroid.external.open.RunIntentActivity",
  );
  nof.setContentIntent(
