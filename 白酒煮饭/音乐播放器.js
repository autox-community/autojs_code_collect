...
ui.layout(
  <frame>
    <vertical>
      <text gravity="center" color="#ff6600" size="30dp">
        试听
      </text>
      ...
      <img
        ...
        src="@drawable/ic_music_note_black_48dp"
        w="400"
        h="400"
        tint="white"
        bg="#ff6600"
      ...
      <horizontal gravity="center" layout_gravity="center" marginTop="10">
        ...
        <frame>
          ...
          <img
            id="暂停播放"
            src="@drawable/ic_pause_black_48dp"
            layout_gravity="center"
            w="50"
            h="50"
            tint="white"
...
ui.快退.click(function () {
  if (musicFiles.length) {
    CurrentMusic--;
    CurrentMusic =
      0 <= CurrentMusic && CurrentMusic < musicFiles.length
        ? CurrentMusic
        : 0 <= CurrentMusic
          ? 0
          : musicFiles.length - 1;
