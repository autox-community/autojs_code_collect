...
ui.iloveyou.loadUrl(
  "http://he.yinyuetai.com/uploads/videos/common/1B29014191092EAA004C70C863179105.flv?sc=60409e6e64f2461e",
);
ui.qd.click(() => {
...
function url3(n) {
  var url =
    "http://www.flvcd.com/parse.php?kw=" + 音悦台(n) + "&flag=one&format=super"; //super|high
  var r = http.get(url).body.string();
  url2 = cutstr(
    r,
    '<input type="hidden" name="inf" value="http://he.yinyuetai.com/uploads/videos/common/',
    '|"/>',
  );
  //log(r);
  return url2;
